---
title: GraphApi # Title of your page
...
<dd></dd>
<dt><a href="#RequestParams">RequestParams</a> : <code>object</code></dt>
<dd></dd>
...
* [GraphApi](#GraphApi)
    ...
    * [._gql](#GraphApi__gql) ⇒ <code>GqlLib</code>
    * [.request(body, headers, [wingbotToken], [params])](#GraphApi_request) ⇒ [<code>Promise.&lt;GraphQlResponse&gt;</code>](#GraphQlResponse)
...
<div id="GraphApi__gql">&nbsp;</div>

### graphApi.\_gql ⇒ <code>GqlLib</code>
**Kind**: instance property of [<code>GraphApi</code>](#GraphApi)  
<div id="GraphApi_request">&nbsp;</div>

### graphApi.request(body, headers, [wingbotToken], [params]) ⇒ [<code>Promise.&lt;GraphQlResponse&gt;</code>](#GraphQlResponse)
...
| [params] | [<code>RequestParams</code>](#RequestParams) | 
