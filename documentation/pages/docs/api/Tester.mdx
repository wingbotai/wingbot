---
title: Tester # Title of your page
section: API # Sidebar navigation group title
order: 5 # Order in the sidebar navigation group
---
...
* [Tester](#Tester)
    ...
    * _instance_
        ...
        * [.prompts](#Tester_prompts) : <code>Array.&lt;PromptInfo&gt;</code>
        ...
        * [.ATTACHMENT_MOCK_URL](#Tester_ATTACHMENT_MOCK_URL)
        * [.setExpandRandomTexts([fixedIndex])](#Tester_setExpandRandomTexts)
        ...
        * [.passedAction(path, [matchRequestActions])](#Tester_passedAction) ⇒ <code>this</code>
        ...
        * [.anyPrompt()](#Tester_anyPrompt) ⇒ <code>PromptAssert</code>
        * [.lastPrompt()](#Tester_lastPrompt) ⇒ <code>PromptAssert</code>
        * [.getLastPromptResult()](#Tester_getLastPromptResult) ⇒ <code>LLMMessage</code>
        * [.stateContains(object, [deep])](#Tester_stateContains)
        * [.text(text)](#Tester_text) ⇒ <code>Promise</code>
        * [.attachment(type, [url])](#Tester_attachment) ⇒ <code>Promise</code>
        * [.intent(intent, [text], [score])](#Tester_intent) ⇒ <code>Promise</code>
        * [.intentWithEntity(intent, entity, [value], [text], [score], [entityScore])](#Tester_intentWithEntity) ⇒ <code>Promise</code>
        * [.entity(entity, [value], [text], [score])](#Tester_entity) ⇒ <code>Promise</code>
        ...
        * [.debug([full], [showPrivateKeys])](#Tester_debug)
    * _static_
...
<div id="Tester_prompts">&nbsp;</div>

### tester.prompts : <code>Array.&lt;PromptInfo&gt;</code>
**Kind**: instance property of [<code>Tester</code>](#Tester)  
...
<div id="Tester_ATTACHMENT_MOCK_URL">&nbsp;</div>

### tester.ATTACHMENT\_MOCK\_URL
**Kind**: instance property of [<code>Tester</code>](#Tester)  
**Properties**
...
### tester.passedAction(path, [matchRequestActions]) ⇒ <code>this</code>
...
| [matchRequestActions] | <code>boolean</code> | <code>false</code> | 
...
<div id="Tester_anyPrompt">&nbsp;</div>

### tester.anyPrompt() ⇒ <code>PromptAssert</code>
**Kind**: instance method of [<code>Tester</code>](#Tester)  
<div id="Tester_lastPrompt">&nbsp;</div>

### tester.lastPrompt() ⇒ <code>PromptAssert</code>
**Kind**: instance method of [<code>Tester</code>](#Tester)  
<div id="Tester_getLastPromptResult">&nbsp;</div>

### tester.getLastPromptResult() ⇒ <code>LLMMessage</code>
**Kind**: instance method of [<code>Tester</code>](#Tester)  
<div id="Tester_stateContains">&nbsp;</div>
...
<div id="Tester_attachment">&nbsp;</div>

### tester.attachment(type, [url]) ⇒ <code>Promise</code>
Sends attachment
...
| Param | Type | Default |
| --- | --- | --- |
| type | <code>&#x27;image&#x27;</code> \| <code>&#x27;audio&#x27;</code> \| <code>&#x27;video&#x27;</code> \| <code>&#x27;file&#x27;</code> | <code>file</code> | 
...
### tester.intentWithEntity(intent, entity, [value], [text], [score], [entityScore]) ⇒ <code>Promise</code>
...
| [entityScore] | <code>number</code> |  | 

<div id="Tester_entity">&nbsp;</div>

### tester.entity(entity, [value], [text], [score]) ⇒ <code>Promise</code>
...
| Param | Type | Default |
| --- | --- | --- |
| [full] | <code>boolean</code> | <code>false</code> | 
| [showPrivateKeys] | <code>boolean</code> | <code>false</code> | 
...
| [processorOptions] | <code>ProcessorOptions</code> | <code>{}</code> | options for Processor |
...
* [ResponseAssert](#ResponseAssert)
    ...
    * _static_
        ...
        * [.AnyResponseAssert#quickReplyTextNotContains(search)](#ResponseAssert_AnyResponseAssert_quickReplyTextNotContains) ⇒ <code>this</code>
...
<div id="ResponseAssert_AnyResponseAssert_quickReplyTextNotContains">&nbsp;</div>

### ResponseAssert.AnyResponseAssert#quickReplyTextNotContains(search) ⇒ <code>this</code>
...
* [ConversationTester](#ConversationTester)
    ...
    * [.test(validationRequestBody, [step], [lang], [snapshot])](#ConversationTester_test) ⇒ [<code>Promise.&lt;TestsOutput&gt;</code>](#TestsOutput)
    ...
    * [._createTester(testsGroup, [botconfig], [lang], [snapshot])](#ConversationTester__createTester) ⇒ [<code>Promise.&lt;Tester&gt;</code>](#Tester)
    * [._runTextCaseTests(testsGroup, botconfig, [lang], [snapshot])](#ConversationTester__runTextCaseTests)
    * [._runStepCaseTests(testsGroup, botconfig, [lang], [snapshot])](#ConversationTester__runStepCaseTests)
    * [.executeTextCase(testsGroup, t, textCase, botconfig, longestText, [lang], [snapshot])](#ConversationTester_executeTextCase)
...
| [options.textThreshold] | <code>number</code> |  |
...
| [options.log] | [<code>Logger</code>](#Logger) |  |
...
### conversationTester.test(validationRequestBody, [step], [lang], [snapshot]) ⇒ [<code>Promise.&lt;TestsOutput&gt;</code>](#TestsOutput)
...
| [snapshot] | <code>string</code> | <code>null</code> | 
...
### conversationTester.\_createTester(testsGroup, [botconfig], [lang], [snapshot]) ⇒ [<code>Promise.&lt;Tester&gt;</code>](#Tester)
**Kind**: instance method of [<code>ConversationTester</code>](#ConversationTester)  
...
| Param | Type | Description |
| --- | --- | --- |
| bot | <code>Router</code> \| <code>ReducerWrapper</code> \| <code>BuildRouter</code> | the chatbot itself |
