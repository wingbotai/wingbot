---
title: Notifications # Title of your page
section: API # Sidebar navigation group title
order: 10 # Order in the sidebar navigation group
---
...
<dd></dd>
<dt><a href="#SenderSubscription">SenderSubscription</a> : <code>object</code></dt>
<dd></dd>
<dt><a href="#Logger">Logger</a> : <code>object</code></dt>
<dd></dd>
<dt><a href="#NotificationsOptions">NotificationsOptions</a> : <code>object</code></dt>
<dd></dd>
...
<dd></dd>
<dt><a href="#SubscriptionData">SubscriptionData</a> : <code>object</code></dt>
<dd></dd>
</dl>
...
* [Notifications](#Notifications)
    ...
    * _instance_
        * [.limit](#Notifications_limit) : <code>number</code>
        * [.sendLimit](#Notifications_sendLimit) : <code>number</code>
        ...
        * [.getSubscriptions(senderId, pageId)](#Notifications_getSubscriptions) ⇒ <code>Promise.&lt;Array.&lt;SenderSubscription&gt;&gt;</code>
...
<div id="Notifications_limit">&nbsp;</div>

### notifications.limit : <code>number</code>
**Kind**: instance property of [<code>Notifications</code>](#Notifications)  
<div id="Notifications_sendLimit">&nbsp;</div>

### notifications.sendLimit : <code>number</code>
**Kind**: instance property of [<code>Notifications</code>](#Notifications)  
...
<div id="Notifications_getSubscriptions">&nbsp;</div>

### notifications.getSubscriptions(senderId, pageId) ⇒ <code>Promise.&lt;Array.&lt;SenderSubscription&gt;&gt;</code>
Get user subscribtions
...
| options | [<code>NotificationsOptions</code>](#NotificationsOptions) | 
...
<div id="SenderSubscription">&nbsp;</div>

## SenderSubscription : <code>object</code>
**Kind**: global typedef  
**Properties**
...
<div id="NotificationsOptions">&nbsp;</div>

## NotificationsOptions : <code>object</code>
**Kind**: global typedef  
**Properties**
...
| senderId | <code>string</code> | 
| pageId | <code>string</code> | 
| [meta] | <code>Object.&lt;string, object&gt;</code> | 
...
## SubscriptionData : <code>object</code>
**Kind**: global typedef  
**Properties**
