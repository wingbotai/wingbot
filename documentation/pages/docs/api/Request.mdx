---
title: Request # Title of your page
section: API # Sidebar navigation group title
order: 0 # Order in the sidebar navigation group
---
...
<dt><a href="#FEATURE_TRACKING">FEATURE_TRACKING</a> : <code>string</code></dt>
<dd><p>channel supports tracking protocol</p>
</dd>
<dt><a href="#FEATURE_VOICE">FEATURE_VOICE</a> : <code>string</code></dt>
<dd><p>channel supports voice messages</p>
</dd>
...
* [Request](#Request)
    ...
    * [new Request(event, state, pageId, globalIntents, [orchestratorOptions], [configuration])](#new_Request_new)
    * [.params](#Request_params)
    * [.attachments](#Request_attachments) : [<code>Array.&lt;Attachment&gt;</code>](#Attachment)
    * [.timestamp](#Request_timestamp) : <code>number</code> \| <code>null</code>
    * [.senderId](#Request_senderId) : <code>string</code>
    * [.recipientId](#Request_recipientId) : <code>string</code>
    * [.pageId](#Request_pageId) : <code>string</code>
    * [.state](#Request_state) : <code>S</code>
    * [.features](#Request_features) : <code>Array.&lt;string&gt;</code>
    * [.subscribtions](#Request_subscribtions) : <code>Array.&lt;string&gt;</code>
    * [.entities](#Request_entities) : [<code>Array.&lt;Entity&gt;</code>](#Entity)
    * [.intents](#Request_intents) : [<code>Array.&lt;Intent&gt;</code>](#Intent)
    * [._orchestratorClientOptions](#Request__orchestratorClientOptions) : <code>OrchestratorClientOptions</code>
    * [.configuration](#Request_configuration) : <code>C</code>
...
<div id="Request_attachments">&nbsp;</div>

### request.attachments : [<code>Array.&lt;Attachment&gt;</code>](#Attachment)
**Kind**: instance property of [<code>Request</code>](#Request)  
<div id="Request_timestamp">&nbsp;</div>

### request.timestamp : <code>number</code> \| <code>null</code>
timestamp

**Kind**: instance property of [<code>Request</code>](#Request)  
<div id="Request_senderId">&nbsp;</div>

### request.senderId : <code>string</code>
senderId sender.id from the event

**Kind**: instance property of [<code>Request</code>](#Request)  
<div id="Request_recipientId">&nbsp;</div>

### request.recipientId : <code>string</code>
recipientId recipient.id from the event

**Kind**: instance property of [<code>Request</code>](#Request)  
<div id="Request_pageId">&nbsp;</div>

### request.pageId : <code>string</code>
pageId page identifier from the event

**Kind**: instance property of [<code>Request</code>](#Request)  
<div id="Request_state">&nbsp;</div>

### request.state : <code>S</code>
current state of the conversation

**Kind**: instance property of [<code>Request</code>](#Request)  
<div id="Request_features">&nbsp;</div>

### request.features : <code>Array.&lt;string&gt;</code>
features supported messaging features

**Kind**: instance property of [<code>Request</code>](#Request)  
<div id="Request_subscribtions">&nbsp;</div>

### request.subscribtions : <code>Array.&lt;string&gt;</code>
state list of subscribed tags

**Kind**: instance property of [<code>Request</code>](#Request)  
<div id="Request_entities">&nbsp;</div>

### request.entities : [<code>Array.&lt;Entity&gt;</code>](#Entity)
entities list of entities

**Kind**: instance property of [<code>Request</code>](#Request)  
<div id="Request_intents">&nbsp;</div>

### request.intents : [<code>Array.&lt;Intent&gt;</code>](#Intent)
...
**Kind**: instance property of [<code>Request</code>](#Request)  
<div id="Request_configuration">&nbsp;</div>

### request.configuration : <code>C</code>
**Kind**: instance property of [<code>Request</code>](#Request)  
...
**Kind**: global constant  
<div id="FEATURE_TRACKING">&nbsp;</div>

## FEATURE\_TRACKING : <code>string</code>
...
| Name | Type |
| --- | --- |
| type | <code>&#x27;file&#x27;</code> \| <code>&#x27;audio&#x27;</code> \| <code>&#x27;video&#x27;</code> \| <code>&#x27;image&#x27;</code> | 
| payload | <code>object</code> | 
| payload.url | <code>string</code> | 
